...
Artificial Intelligence is a theme. It wants to take your  team's website and give it superpowers.
...
* Grab the attention of visitors and spread the mission of with a super awesome homepage. Put your photos up front and center for the world to see.
...
AI does not officially support Internet Explorer 8. It includes , [HTML5 Shiv] to help with backwards-compatibility, but does not implement further support.
...
1. Download the  of Artificial Intelligence to your computer. Make sure to get the distribution release! (big green button)
...
As AI is hosted on GitHub rather than the WordPress Theme Repo, you will not see available updates by default. A workaround for this is to install the [GitHub Updater]plugin; you will have to download it from its repo and upload it to your install.
